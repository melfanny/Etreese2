        ...
        <div class="order-overview-container">
            ...
            <div class="order-list">
                @forelse($orders as $order)
                    <div class="order-card" style="@if($order->status == 'waiting_payment') border:2px solid orange; @endif">
                        <img src="{{ $order->product && $order->product->image ? asset('storage/' . $order->product->image) : asset('images/sample-product.jpg') }}" class="product-thumb">
